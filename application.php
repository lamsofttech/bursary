...
<script defer src="https://kit.fontawesome.com/885a196d5c.js" crossorigin="anonymous"></script>
  ...
  ?>
            ...
            <div class="formContents">
                <form  class="personalInformationForm" id="SOMUForm" method="POST" action="application.php" enctype="multipart/form-data" >
        ...
        <div class="family-status-content" id="familyStatus-form">
                ...
                <input name="disabled" type="checkbox" class="disabled" value="yes"><br>
                ...
                <p class="loan-disclaimer">Indicate clearly, organization and amount (e.g. HELB, 25000)</p>
                  ...
                  <div class="academic-menu">
                   ...
                   <div class="app-submit-btn-div">
                    <a name="submit_application_btn" class="btn btn-primary loan-details-btn-save" type="submit">Submit Application</a>
                  </div>
                  </div>
                       </form>
            </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col">
          ...
          <a href="studentDashboard.php #top" class="footer-menu">Home</a>
      ...
      <div class="col">
       ...
       <a class="fa fa-twitter fa-2x" href="https://twitter.com/Maseno_Uni"></a>
       <a class="fa fa-facebook fa-2x" href="https://facebook.com/MasenoUniversity"></a>
       <a class="fa fa-instagram fa-2x" href="https://instagram.com/maseno_university_"></a>
      </div>
    </div>
