            ...
            <!--Navigation Bar section-->
                    <nav class="navbar navbar-dark navbar-expand-lg fixed-top">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                          <div class="navbar-nav ml-auto">
                            ...
                            <a class="nav-item nav-link active" href="disbursement.php">Disbursment</a>
                ...
                <div class="disbursement-form">
                  <div class="cheque-section">
                      ...
                      <p>Cheque number assigned: <strong style="color:green;"><?php echo $chequeno?></strong></p>
                      <p>Do you wish to update the cheque number?</p>
                      <form method="POST" action="">
                          <label class="label-heading">Cheque Number:</label>
                          <input type="text" name="cheque" class="cheque-number"><br>
